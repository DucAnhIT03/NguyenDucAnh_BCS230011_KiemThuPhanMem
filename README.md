...
## Bài tập ngày 05/01/2026: Can't Unsee

### Mô tả bài tập
**Can't Unsee** là một mini-game giúp rèn luyện khả năng phát hiện các lỗi trong thiết kế **UI/UX**.  
Bài tập yêu cầu quan sát và nhận diện các vấn đề liên quan đến:
- Căn chỉnh giao diện (Alignment)
- Khoảng cách giữa các thành phần (Spacing)
- Tính nhất quán (Consistency)
- Khả năng đọc và trải nghiệm người dùng (Readability & UX)

🔗 Link bài tập: https://cantunsee.space

### Kết quả đạt được
- **Điểm số**: **7830**
- **Xếp hạng**: **PLATINUM (Top 2%)**
...
![Can't Unsee Result](./Screenshot%202026-01-05%20143631.png)
...
## Bài tập ngày 07/01/2026: Kiểm thử với JUnit
...
- Giá trị trả về:
   ...
   - `calculateValidAverage`: trung bình cộng các điểm hợp lệ; nếu không có điểm hợp lệ trả về 0.0 (tránh `ArithmeticException`).
